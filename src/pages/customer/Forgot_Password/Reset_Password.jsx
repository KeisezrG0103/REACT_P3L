    ...
    <div className="w-full h-screen flex">
      <div className="md:w-1/2 w-full flex justify-center items-center">
        <div className="card w-80 mx-auto">
          ...
          <div className="text-2xl font-bold text-center mb-4 mt-1">
            Change Password
          </div>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mt-5">
              <button
                className="btn btn-primary w-full text-white relative mt-2"
                type="submit"
                disabled={isLoading}
              >
                {isLoading && (
                  <div className="absolute inset-0 flex justify-center items-center">
                    <div
                      className="spinner-border h-5 w-5 text-white"
                      role="status"
                    >
