      ...
      <div className="app__bg app__wrapper section__padding" id="contact">
        <div className="app__wrapper_info">
          ...
          <p className="p__opensans">
            Hubungi kami jika ada pertanyaan atau masukan, kami akan dengan
            senang membantu.
          </p>
          <div className="app__wrapper-content">
            <div className="flex items-center space-x-4 mt-8">
              <IoLocationSharp size={22}></IoLocationSharp>
              <p className="p__opensans text-2xl font-bold">Alamat</p>
            </div>
            <p className="p__opensans mt-2">
              {" "}
              Jl. Kaliurang KM 5 No.100, Kocoran, Sinduadi, Kec. Mlati,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="mt-4">
                <div>
                  <p className="p__opensans text-2xl font-bold mt-1 mb-2">
                    Waktu Operasional
                  </p>
            ...
            <div className="mt-4">
              <div>
                ...
                <div className="flex items-center space-x-4 mt-2">
                  ...
                  <a
                    className="p__opensans hover:font-bold"
                    href="https://www.instagram.com/uajy"
                    target="_blank"
                  ...
                  <a
                    className="p__opensans hover:font-bold"
                    href="https://web.facebook.com/universitas.atma.jaya.yogyakarta"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Atma Kitchen Official
                  </a>
                  <BsTwitter size={18}></BsTwitter>
                  <a
                    className="p__opensans hover:font-bold"
                    href="https://x.com/uajy"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    @AtmaKitchen
            ...
            <div className="mt-4">
              <div>
                ...
                <div className="flex items-center space-x-4 mt-2">
                  ...
                  <p className="p__opensans">atmakicthen898@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="section__padding">
        ...
        <div className="flex items-center space-x-4 mt-12 mb-2">
          ...
          <p className="p__opensans text-2xl font-bold">
            Apakah ada batas waktu pembayaran dalam pemesanan online?
          </p>
        </div>
        <p className="p__opensans text-xl ml-8 mt-4" style={{ lineHeight: 2 }}>
          Untuk pesanan <em>Ready Stock</em>, tenggatnya adalah 1 jam. Untuk
          pesanan <em>Pre-Order</em> pada H-2, tenggatnya adalah 1 jam. Jika
          pesanan <em>Pre-Order</em> dilakukan pada H-3+, tenggatnya adalah pada
          H-2.
        </p>
        <div className="flex items-center space-x-4 mt-12 mb-2">
          <TbPointFilled></TbPointFilled>
          <p className="p__opensans text-2xl font-bold">
            Apakah ada biaya pengiriman untuk pesanan yang dikirim oleh kurir
            Atma Kitchen?
          </p>
        </div>
        <p className="p__opensans text-xl ml-8 mt-4" style={{ lineHeight: 2 }}>
          Ada. Biaya dihitung dari jarak outlet Atma Kitchen ke alamat Customer.
        </p>
      </div>
      <div className="section__padding">
        <h1 className="app__header-h1 text-center">
