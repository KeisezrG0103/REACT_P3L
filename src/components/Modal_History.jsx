          ...
          <table className="table w-full">
            ...
            {isLoading ? (
                ...
                historyData.data.map((history, index) => (
                  ...
                  <td>{history.Tanggal_Pesan ? history.Tanggal_Pesan : "-"}</td>
                  <td>{history.Tanggal_Pelunasan ? history.Tanggal_Pelunasan : "-"}</td>
                  <td>{history.Tanggal_Diambil ? history.Tanggal_Diambil : "-"}</td>
                  <td>{history.Bukti_Pembayaran ? history.Bukti_Pembayaran : "-"}</td>
                  <td>{history.Status_Pembayaran ? history.Status_Pembayaran : "-"}</td>
                ...
                <tr>
                  <td colSpan="2">Tidak Ada History</td>
                </tr>
              )}
            </tbody>
          </table>
